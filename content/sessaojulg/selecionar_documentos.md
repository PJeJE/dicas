...
weight: 7
linkTitle: "Selecionar documentos para acórdão"
---
...
As abas **Ementa, Relatório, Voto Relator, Voto Vencedor** e **Acórdão** permitem a seleção de apenas uma opção de documento, mas a seleção não é obrigatória. A seleção de apenas um do documento  ocorre porque um processo julgado só pode conter um desses documentos. A aba de votos vogais permite a seleção de mais de um documento, já que todos os vogais que participaram da sessão podem fazer seu voto escrito. 
