...
9. A classe judicial é a própria casse judicial do processo ou, quando possui um recurso interno, é a descrição da classe judicial por extenso (ds_classe_judicial_extenso);

10. A Certidão de Julgamento que será exibida apenas quando o processo estiver Julgado (JG) ou possuir um Pedido de Vista e não estiver julgado (NJ). 
