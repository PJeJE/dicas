...
1.  [Identificação](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Login "Funcionalidades")
    (login)
2.  [Consultas ao andamento processual](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Consulta_p.C3.BAblica "Funcionalidades")
3.  [Verificação de ambiente](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Verifica.C3.A7.C3.A3o_de_ambiente "Funcionalidades")
