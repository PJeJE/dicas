...
[Funcionalidades]{dir="auto"} {#firstHeading .firstHeading}
=============================
...
::: {#mw-content-text .mw-content-ltr lang="pt-BR" dir="ltr"}
Descreveremos as funcionalidades do PJe a partir da estrutura de menus
existente, que consiste nos seguintes: \"Home\", \"Painel\",
\"Processo\", \"Atividades\", \"Audiências e sessões\", \"Configuração\"
e \"Gestão\".\
\
No menu \"Processo\", estão as funcionalidades mais utilizadas quanto a
processos (novo protocolo, reaproveitamento de rascunhos de processos,
ações de solicitar habilitação, envio de processo a instância superior
etc.)\
No menu \"Atividades\", as atividades mais comuns de cada um dos papéis
que não são afetadas a nós de tarefas de fluxos.\
No menu \"Audiências e sessões\", as atividades mais comuns relativas a
esses atos que tambẽm não são acessíveis via nós de tarefas.\
No menu \"Configuração\", as funcionalidades de configuração do sistema,
reunindo o que existia antes em \"Cadastros Auxiliares\" e \"Cadastros
Básicos\".\
No menu \"Gestão\", as funcionalidades de relatórios e estatísticas para
gestão da instalação ou do órgão julgador.

As permissões para acesso às funcionalidades são determinadas pela
restrição
[RN527](http://titanio09.cnj.jus.br/wiki/index.php/Regras_de_neg%C3%B3cio#RN527 "Regras de negócio").

As funcionalidades vinculadas a nós de tarefas de fluxos são
disponibilizadas através dos painéis do usuário.
...
| --------                                                              |
|                                                                       |
| [ \[[ocultar](#){#togglelink .internal}\] ]{.toctoggle}               |
| :::                                                                   |
|                                                                       |
| -   [[1]{.tocnumber} [Tela principal]{.toctext}](#Tela_principal)     |
| -   [[2]{.tocnumber} [Consulta                                        |
|     pública]{.toctext}](#Consulta_p.C3.BAblica)                       |
| -   [[3]{.tocnumber} [Verificação de                                  |
|     ambiente]{.toctext}](#Verifica.C3.A7.C3.A3o_de_ambiente)          |
| -   [[4]{.tocnumber} [Login]{.toctext}](#Login)                       |
|     -   [[4.1]{.tocnumber} [Certificado próximo de                    |
|         expirar]{.toctext}](#Certificado_pr.C3.B3ximo_de_expirar)     |
| -   [[5]{.tocnumber} [Ajuda de                                        |
|     contexto]{.toctext}](#Ajuda_de_contexto)                          |
| -   [[6]{.tocnumber} [Página                                          |
|     principal]{.toctext}](#P.C3.A1gina_principal)                     |
|     -   [[6.1]{.tocnumber} [Mensagens]{.toctext}](#Mensagens)         |
| -   [[7]{.tocnumber} [Painel]{.toctext}](#Painel)                     |
|     -   [[7.1]{.tocnumber} [Painel do advogado, procurador ou         |
|                                                                       |
|   defensor]{.toctext}](#Painel_do_advogado.2C_procurador_ou_defensor) |
|         -   [[7.1.1]{.tocnumber} [Acervo]{.toctext}](#Acervo)         |
|             -   [[7.1.1.1]{.tocnumber} [Pendentes de                  |
|                                                                       |
|        manifestação]{.toctext}](#Pendentes_de_manifesta.C3.A7.C3.A3o) |
|             -   [[7.1.1.2]{.tocnumber} [Acervo                        |
|                 geral]{.toctext}](#Acervo_geral)                      |
|         -   [[7.1.2]{.tocnumber}                                      |
|             [Expedientes]{.toctext}](#Expedientes)                    |
|             -   [[7.1.2.1]{.tocnumber} [Pendentes de                  |
|                 ciência]{.toctext}](#Pendentes_de_ci.C3.AAncia)       |
|             -   [[7.1.2.2]{.tocnumber} [Ciência dada pelo             |
|                 destinatário e com prazo em                           |
|                 curso]{.toct                                          |
| ext}](#Ci.C3.AAncia_dada_pelo_destinat.C3.A1rio_e_com_prazo_em_curso) |
|             -   [[7.1.2.3]{.tocnumber} [Ciência dada pelo sistema e   |
|                 com prazo em                                          |
|                 cu                                                    |
| rso]{.toctext}](#Ci.C3.AAncia_dada_pelo_sistema_e_com_prazo_em_curso) |
|             -   [[7.1.2.4]{.tocnumber} [Cujo prazo findou nos últimos |
|                 dez                                                   |
|                                                                       |
|        dias]{.toctext}](#Cujo_prazo_findou_nos_.C3.BAltimos_dez_dias) |
|             -   [[7.1.2.5]{.tocnumber} [Sem                           |
|                 prazo]{.toctext}](#Sem_prazo)                         |
|             -   [[7.1.2.6]{.tocnumber} [Respondidos nos últimos 10    |
|                                                                       |
|               dias]{.toctext}](#Respondidos_nos_.C3.BAltimos_10_dias) |
|         -   [[7.1.3]{.tocnumber} [Intimações de                       |
|             pauta]{.toctext}](#Intima.C3.A7.C3.B5es_de_pauta)         |
|         -   [[7.1.4]{.tocnumber}                                      |
|             [Petições]{.toctext}](#Peti.C3.A7.C3.B5es)                |
|     -   [[7.2]{.tocnumber} [Painel do                                 |
|         magistrado]{.toctext}](#Painel_do_magistrado)                 |
|         -   [[7.2.1]{.tocnumber} [Caixas]{.toctext}](#Caixas)         |
|             -   [[7.2.1.1]{.tocnumber} [Perfil de                     |
|                                                                       |
|           visualização]{.toctext}](#Perfil_de_visualiza.C3.A7.C3.A3o) |
|             -   [[7.2.1.2]{.tocnumber} [Localizar                     |
|                 caixa]{.toctext}](#Localizar_caixa)                   |
|                 -   [[7.2.1.2.1]{.tocnumber} [Tarefas de              |
|                     processos]{.toctext}](#Tarefas_de_processos)      |
|             -   [[7.2.1.3]{.tocnumber} [Mover para                    |
|                 caixa]{.toctext}](#Mover_para_caixa)                  |
|             -   [[7.2.1.4]{.tocnumber} [Nova                          |
|                 caixa]{.toctext}](#Nova_caixa)                        |
|             -   [[7.2.1.5]{.tocnumber} [Editar                        |
|                 caixa]{.toctext}](#Editar_caixa)                      |
|             -   [[7.2.1.6]{.tocnumber} [Remover                       |
|                 caixa]{.toctext}](#Remover_caixa)                     |
|         -   [[7.2.2]{.tocnumber}                                      |
|             [Expedientes]{.toctext}](#Expedientes_2)                  |
|             -   [[7.2.2.1]{.tocnumber}                                |
|                 [Pendentes]{.toctext}](#Pendentes)                    |
|                 -   [[7.2.2.1.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador                            |
|                     \'Pendentes\'?]{.toctex                           |
| t}](#Quando_o_expediente_.22entra.22_no_agrupador_.27Pendentes.27.3F) |
|                 -   [[7.2.2.1.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador                              |
|                     \'Pendentes\'?]{.toct                             |
| ext}](#Quando_o_expediente_.22sai.22_do_agrupador_.27Pendentes.27.3F) |
|             -   [[7.2.2.2]{.tocnumber} [Correio(s)                    |
|                                                                       |
|              pendente(s)]{.toctext}](#Correio.28s.29_pendente.28s.29) |
|                 -   [[7.2.2.2.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Correio(s)               |
|                     Pendente(s)\'?]{.toctext}](#Quando_o_expedie      |
| nte_.22entra.22_no_agrupador_.27Correio.28s.29_Pendente.28s.29.27.3F) |
|                 -   [[7.2.2.2.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Correio(s)                 |
|                     Pendente(s)\'?]{.toctext}](#Quando_o_exped        |
| iente_.22sai.22_do_agrupador_.27Correio.28s.29_Pendente.28s.29.27.3F) |
|             -   [[7.2.2.3]{.tocnumber} [Mandado(s)                    |
|                                                                       |
|              pendente(s)]{.toctext}](#Mandado.28s.29_pendente.28s.29) |
|                 -   [[7.2.2.3.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Mandado(s)               |
|                     Pendente(s)\'?]{.toctext}](#Quando_o_expedie      |
| nte_.22entra.22_no_agrupador_.27Mandado.28s.29_Pendente.28s.29.27.3F) |
|                 -   [[7.2.2.3.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Mandado(s)                 |
|                     Pendente(s)\'?]{.toctext}](#Quando_o_exped        |
| iente_.22sai.22_do_agrupador_.27Mandado.28s.29_Pendente.28s.29.27.3F) |
|             -   [[7.2.2.4]{.tocnumber} [Expedientes físicos sem       |
|                 registro de                                           |
|                 intimação]{.toc                                       |
| text}](#Expedientes_f.C3.ADsicos_sem_registro_de_intima.C3.A7.C3.A3o) |
|                 -   [[7.2.2.4.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Expedientes físicos sem  |
|                     registro de                                       |
|                     int                                               |
| imação\'?]{.toctext}](#Quando_o_expediente_.22entra.22_no_agrupador_. |
| 27Expedientes_f.C3.ADsicos_sem_registro_de_intima.C3.A7.C3.A3o.27.3F) |
|                 -   [[7.2.2.4.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Expedientes físicos sem    |
|                     registro de                                       |
|                     i                                                 |
| ntimação\'?]{.toctext}](#Quando_o_expediente_.22sai.22_do_agrupador_. |
| 27Expedientes_f.C3.ADsicos_sem_registro_de_intima.C3.A7.C3.A3o.27.3F) |
|                 -   [[7.2.2.4.3]{.tocnumber} [Registrar               |
|                     intimação/ci                                      |
| tação]{.toctext}](#Registrar_intima.C3.A7.C3.A3o.2Fcita.C3.A7.C3.A3o) |
|             -   [[7.2.2.5]{.tocnumber} [Confirmadas pelo destinatário |
|                 e dentro do                                           |
|                 pra                                                   |
| zo]{.toctext}](#Confirmadas_pelo_destinat.C3.A1rio_e_dentro_do_prazo) |
|                 -   [[7.2.2.5.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Confirmadas pelo         |
|                     destinatário e dentro do                          |
|                                                                       |
|          prazo\'?]{.toctext}](#Quando_o_expediente_.22entra.22_no_agr |
| upador_.27Confirmadas_pelo_destinat.C3.A1rio_e_dentro_do_prazo.27.3F) |
|                 -   [[7.2.2.5.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Confirmadas pelo           |
|                     destinatário e dentro do                          |
|                                                                       |
|            prazo\'?]{.toctext}](#Quando_o_expediente_.22sai.22_do_agr |
| upador_.27Confirmadas_pelo_destinat.C3.A1rio_e_dentro_do_prazo.27.3F) |
|             -   [[7.2.2.6]{.tocnumber} [Confirmadas pelo PJe e dentro |
|                 do                                                    |
|                                                                       |
|            prazo]{.toctext}](#Confirmadas_pelo_PJe_e_dentro_do_prazo) |
|                 -   [[7.2.2.6.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Confirmadas pelo PJe e   |
|                     dentro do                                         |
|                     prazo\'?]{.toctext}](#Quando_o_expediente_.22e    |
| ntra.22_no_agrupador_.27Confirmadas_pelo_PJe_e_dentro_do_prazo.27.3F) |
|                 -   [[7.2.2.6.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Confirmadas pelo PJe e     |
|                     dentro do                                         |
|                     prazo\'?]{.toctext}](#Quando_o_expediente_.2      |
| 2sai.22_do_agrupador_.27Confirmadas_pelo_PJe_e_dentro_do_prazo.27.3F) |
|             -   [[7.2.2.7]{.tocnumber} [Prazos encerrados nos últimos |
|                 10                                                    |
|                                                                       |
|         dias]{.toctext}](#Prazos_encerrados_nos_.C3.BAltimos_10_dias) |
|                 -   [[7.2.2.7.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Prazos encerrados nos    |
|                     últimos 10                                        |
|                     dias\'?]{.toctext}](#Quando_o_expediente_.22entra |
| .22_no_agrupador_.27Prazos_encerrados_nos_.C3.BAltimos_10_dias.27.3F) |
|                 -   [[7.2.2.7.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Prazos encerrados nos      |
|                     últimos 10                                        |
|                     dias\'?]{.toctext}](#Quando_o_expediente_.22sai   |
| .22_do_agrupador_.27Prazos_encerrados_nos_.C3.BAltimos_10_dias.27.3F) |
|             -   [[7.2.2.8]{.tocnumber} [Sem                           |
|                 prazo]{.toctext}](#Sem_prazo_2)                       |
|                 -   [[7.2.2.8.1]{.tocnumber} [Quando o expediente     |
|                     \"entra\" no agrupador \'Sem                      |
|                     prazo\'?]{.toctex                                 |
| t}](#Quando_o_expediente_.22entra.22_no_agrupador_.27Sem_prazo.27.3F) |
|                 -   [[7.2.2.8.2]{.tocnumber} [Quando o expediente     |
|                     \"sai\" do agrupador \'Sem                        |
|                     prazo\'?]{.toct                                   |
| ext}](#Quando_o_expediente_.22sai.22_do_agrupador_.27Sem_prazo.27.3F) |
|             -   [[7.2.2.9]{.tocnumber} [Mandado de prisão/ alvará de  |
|                 soltura/                                              |
|                 contramandado]{.toctext}                              |
| ](#Mandado_de_pris.C3.A3o.2F_alvar.C3.A1_de_soltura.2F_contramandado) |
|         -   [[7.2.3]{.tocnumber}                                      |
|             [Agrupadores]{.toctext}](#Agrupadores)                    |
|             -   [[7.2.3.1]{.tocnumber} [Processos com pedido de       |
|                 segredo de justiça não                                |
|                 apreciado]{.toctext}]                                 |
| (#Processos_com_pedido_de_segredo_de_justi.C3.A7a_n.C3.A3o_apreciado) |
|             -   [[7.2.3.2]{.tocnumber} [Processos com pedido de       |
|                 sigilo nos documentos não                             |
|                 apreciado]{.toctext                                   |
| }](#Processos_com_pedido_de_sigilo_nos_documentos_n.C3.A3o_apreciado) |
|             -   [[7.2.3.3]{.tocnumber} [Processos com pedido de       |
|                 assistência judiciária gratuita não                   |
|                 apreciado]{.toctext}](#Processos_com_pe               |
| dido_de_assist.C3.AAncia_judici.C3.A1ria_gratuita_n.C3.A3o_apreciado) |
|             -   [[7.2.3.4]{.tocnumber} [Processos com pedido liminar  |
|                 ou com antecipação de tutela não                      |
|                 apreciados]{.toctext}](#Processos_com_pedid           |
| o_liminar_ou_com_antecipa.C3.A7.C3.A3o_de_tutela_n.C3.A3o_apreciados) |
|             -   [[7.2.3.5]{.tocnumber} [Processos com habilitação nos |
|                 autos não                                             |
|                 lidas]{.toc                                           |
| text}](#Processos_com_habilita.C3.A7.C3.A3o_nos_autos_n.C3.A3o_lidas) |
|             -   [[7.2.3.6]{.tocnumber} [Processos em análise de       |
|                 pre                                                   |
| venção]{.toctext}](#Processos_em_an.C3.A1lise_de_preven.C3.A7.C3.A3o) |
|             -   [[7.2.3.7]{.tocnumber} [Processos com documentos não  |
|                                                                       |
|           lidos]{.toctext}](#Processos_com_documentos_n.C3.A3o_lidos) |
|             -   [[7.2.3.8]{.tocnumber} [Mandados devolvidos pelo      |
|                 oficial de                                            |
|                 j                                                     |
| ustiça]{.toctext}](#Mandados_devolvidos_pelo_oficial_de_justi.C3.A7a) |
|             -   [[7.2.3.9]{.tocnumber} [Processos aguardando revisão  |
|                 / revisados / devolvidos pelo                         |
|                 revisor]{.toctext}](#Process                          |
| os_aguardando_revis.C3.A3o_.2F_revisados_.2F_devolvidos_pelo_revisor) |
|             -   [[7.2.3.10]{.tocnumber} [Processos aguardando         |
|                 encaminhamento do secretário de audiência(atas        |
|                 assinadas)]{.toctext}](#Processos_aguardando_enc      |
| aminhamento_do_secret.C3.A1rio_de_audi.C3.AAncia.28atas_assinadas.29) |
|         -   [[7.2.4]{.tocnumber} [Últimas tarefas                     |
|             realizadas]{.toctext}](#.C3.9Altimas_tarefas_realizadas)  |
|     -   [[7.3]{.tocnumber} [Painel do                                 |
|         usuário]{.toctext}](#Painel_do_usu.C3.A1rio)                  |
|     -   [[7.4]{.tocnumber} [Painel do magistrado na                   |
|         sessão]{.toctext}](#Painel_do_magistrado_na_sess.C3.A3o)      |
|     -   [[7.5]{.tocnumber} [Painel do oficial de                      |
|         justiça]{.toctext}](#Painel_do_oficial_de_justi.C3.A7a)       |
|         -   [[7.5.1]{.tocnumber} [Controle de                         |
|             visita]{.toctext}](#Controle_de_visita)                   |
|             -   [[7.5.1.1]{.tocnumber} [Controle de                   |
|                 visita]{.toctext}](#Controle_de_visita_2)             |
|             -   [[7.5.1.2]{.tocnumber} [Resultado da                  |
|                 diligência]{.toctext}](#Resultado_da_dilig.C3.AAncia) |
|     -   [[7.6]{.tocnumber} [Painel do oficial de                      |
|         justiça]{.toctext}](#Painel_do_oficial_de_justi.C3.A7a_2)     |
|         -   [[7.6.1]{.tocnumber} [Expedientes para                    |
|             r                                                         |
| edistribuição]{.toctext}](#Expedientes_para_redistribui.C3.A7.C3.A3o) |
|             -   [[7.6.1.1]{.tocnumber}                                |
|                 [Redistribuir]{.toctext}](#Redistribuir)              |
|         -   [[7.6.2]{.tocnumber} [Expedientes para                    |
|                                                                       |
|    distribuição]{.toctext}](#Expedientes_para_distribui.C3.A7.C3.A3o) |
|             -   [[7.6.2.1]{.tocnumber}                                |
|                 [Distribuir]{.toctext}](#Distribuir)                  |
|     -   [[7.7]{.tocnumber} [Painel do                                 |
|         perito]{.toctext}](#Painel_do_perito)                         |
|     -   [[7.8]{.tocnumber} [Painel do procurador na                   |
|         sessão]{.toctext}](#Painel_do_procurador_na_sess.C3.A3o)      |
|     -   [[7.9]{.tocnumber} [Painel do membro do Ministério Público na |
|         sessão]{.toctex                                               |
| t}](#Painel_do_membro_do_Minist.C3.A9rio_P.C3.BAblico_na_sess.C3.A3o) |
|     -   [[7.10]{.tocnumber} [Painel do secretário da                  |
|         sessão]{.toctext}](#Painel_do_secret.C3.A1rio_da_sess.C3.A3o) |
|     -   [[7.11]{.tocnumber} [Quadro de                                |
|         avisos]{.toctext}](#Quadro_de_avisos)                         |
| -   [[8]{.tocnumber} [Tarefas]{.toctext}](#Tarefas)                   |
|     -   [[8.1]{.tocnumber} [Barra de                                  |
|         tarefas]{.toctext}](#Barra_de_tarefas)                        |
|     -   [[8.2]{.tocnumber} [Tarefas de                                |
|         audiência]{.toctext}](#Tarefas_de_audi.C3.AAncia)             |
|         -   [[8.2.1]{.tocnumber} [Designar                            |
|             audiência]{.toctext}](#Designar_audi.C3.AAncia)           |
|         -   [[8.2.2]{.tocnumber}                                      |
|             [Audiência]{.toctext}](#Audi.C3.AAncia)                   |
|             -   [[8.2.2.1]{.tocnumber} [Etapas]{.toctext}](#Etapas)   |
|     -   [[8.3]{.tocnumber} [Retificar                                 |
|         autuação]{.toctext}](#Retificar_autua.C3.A7.C3.A3o)           |
|     -   [[8.4]{.tocnumber} [Preparar                                  |
|         juntada]{.toctext}](#Preparar_juntada)                        |
|     -   [[8.5]{.tocnumber} [Avaliar                                   |
|         juntada]{.toctext}](#Avaliar_juntada)                         |
|     -   [[8.6]{.tocnumber} [Preparar                                  |
|         comunicação]{.toctext}](#Preparar_comunica.C3.A7.C3.A3o)      |
|     -   [[8.7]{.tocnumber} [Imprimir                                  |
|         correspondência]{.toctext}](#Imprimir_correspond.C3.AAncia)   |
|     -   [[8.8]{.tocnumber}                                            |
|         [Redistribuição]{.toctext}](#Redistribui.C3.A7.C3.A3o)        |
|     -   [[8.9]{.tocnumber} [Minutar ato]{.toctext}](#Minutar_ato)     |
|         -   [[8.9.1]{.tocnumber} [Minutar em                          |
|             lote]{.toctext}](#Minutar_em_lote)                        |
|     -   [[8.10]{.tocnumber} [Confirmar                                |
|         ato]{.toctext}](#Confirmar_ato)                               |
|     -   [[8.11]{.tocnumber} [Redistribuir                             |
|         processo]{.toctext}](#Redistribuir_processo)                  |
|     -   [[8.12]{.tocnumber} [Reclassificar tipo de                    |
|         documento]{.toctext}](#Reclassificar_tipo_de_documento)       |
|     -   [[8.13]{.tocnumber} [Preparar remessa para o 2º               |
|         grau]{.toctext}](#Preparar_remessa_para_o_2.C2.BA_grau)       |
|     -   [[8.14]{.tocnumber} [Preparar remessa de manifestação         |
|         processual para envio à instância                             |
|         superior]{.toctext}](#Preparar_remessa_de_manifes             |
| ta.C3.A7.C3.A3o_processual_para_envio_.C3.A0_inst.C3.A2ncia_superior) |
|     -   [[8.15]{.tocnumber} [Informação processual                    |
|         co                                                            |
| mplementar]{.toctext}](#Informa.C3.A7.C3.A3o_processual_complementar) |
|         -   [[8.15.1]{.tocnumber} [Informação processual complementar |
|             do tipo                                                   |
|             prisão]{.toctext                                          |
| }](#Informa.C3.A7.C3.A3o_processual_complementar_do_tipo_pris.C3.A3o) |
|         -   [[8.15.2]{.tocnumber} [Informação processual complementar |
|             do tipo                                                   |
|             fuga]{.                                                   |
| toctext}](#Informa.C3.A7.C3.A3o_processual_complementar_do_tipo_fuga) |
|         -   [[8.15.3]{.tocnumber} [Informação processual complementar |
|             do tipo                                                   |
|             soltura]{.toc                                             |
| text}](#Informa.C3.A7.C3.A3o_processual_complementar_do_tipo_soltura) |
|         -   [[8.15.4]{.tocnumber} [Informação processual complementar |
|             de alguns tipos da área                                   |
|             criminal]{.toctext}](#Informa.C3.A7.                      |
| C3.A3o_processual_complementar_de_alguns_tipos_da_.C3.A1rea_criminal) |
|         -   [[8.15.5]{.tocnumber} [Informação processual complementar |
|             de todos os                                               |
|             tipos]{.tocte                                             |
| xt}](#Informa.C3.A7.C3.A3o_processual_complementar_de_todos_os_tipos) |
|         -   [[8.15.6]{.tocnumber} [Informação processual complementar |
|             do tipo transferência do                                  |
|             réu]{.toctext}](#Informa.C3.A7.C                          |
| 3.A3o_processual_complementar_do_tipo_transfer.C3.AAncia_do_r.C3.A9u) |
|         -   [[8.15.7]{.tocnumber} [Informação processual complementar |
|             do tipo obrigações a                                      |
|             pagar]{.toctext}](#Informa.C3.A7                          |
| .C3.A3o_processual_complementar_do_tipo_obriga.C3.A7.C3.B5es_a_pagar) |
|         -   [[8.15.8]{.tocnumber} [Informação processual complementar |
|             do tipo tipificação do                                    |
|             delito]{.toctext}](#Informa.C3.A7.C3                      |
| .A3o_processual_complementar_do_tipo_tipifica.C3.A7.C3.A3o_do_delito) |
|         -   [[8.15.9]{.tocnumber} [Informação processual complementar |
|             do tipo aditamento da                                     |
|             denúncia]{.toctext}](#Informa.C3.A                        |
| 7.C3.A3o_processual_complementar_do_tipo_aditamento_da_den.C3.BAncia) |
|         -   [[8.15.10]{.tocnumber} [Informação processual             |
|             complementar do tipo                                      |
|             queixa]{.to                                               |
| ctext}](#Informa.C3.A7.C3.A3o_processual_complementar_do_tipo_queixa) |
|         -   [[8.15.11]{.tocnumber} [Informação processual             |
|             complementar do tipo aditamento da                        |
|             queixa]{.toctext}](#Infor                                 |
| ma.C3.A7.C3.A3o_processual_complementar_do_tipo_aditamento_da_queixa) |
|         -   [[8.15.12]{.tocnumber} [Informação processual             |
|             complementar do tipo atribuição de autoria dos            |
|             fatos]{.toctext}](#Informa.C3.A7.C3.A3o_proce             |
| ssual_complementar_do_tipo_atribui.C3.A7.C3.A3o_de_autoria_dos_fatos) |
|         -   [[8.15.13]{.tocnumber} [Informação processual             |
|             complementar do tipo                                      |
|             desclassificação]{.toctext}](#Informa.C3.                 |
| A7.C3.A3o_processual_complementar_do_tipo_desclassifica.C3.A7.C3.A3o) |
|         -   [[8.15.14]{.tocnumber} [Informação processual             |
|             complementar do tipo oferecimento da                      |
|             denúncia]{.toctext}](#Informa.C3.A7.                      |
| C3.A3o_processual_complementar_do_tipo_oferecimento_da_den.C3.BAncia) |
| -   [[9]{.tocnumber} [Processo]{.toctext}](#Processo)                 |
|     -   [[9.1]{.tocnumber} [Novo processo]{.toctext}](#Novo_processo) |
|         -   [[9.1.1]{.tocnumber} [Dados                               |
|             iniciais]{.toctext}](#Dados_iniciais)                     |
|         -   [[9.1.2]{.tocnumber} [Assuntos]{.toctext}](#Assuntos)     |
|         -   [[9.1.3]{.tocnumber} [Partes]{.toctext}](#Partes)         |
|             -   [[9.1.3.1]{.tocnumber} [Informações                   |
|                 pessoais]{.toctext}](#Informa.C3.A7.C3.B5es_pessoais) |
|             -   [[9.1.3.2]{.tocnumber} [Documentos de                 |
|                                                                       |
|     identificação]{.toctext}](#Documentos_de_identifica.C3.A7.C3.A3o) |
|             -   [[9.1.3.3]{.tocnumber}                                |
|                 [Endereços]{.toctext}](#Endere.C3.A7os)               |
|             -   [[9.1.3.4]{.tocnumber} [Meios de                      |
|                 contato]{.toctext}](#Meios_de_contato)                |
|             -   [[9.1.3.5]{.tocnumber} [Características               |
|                 pessoais]{.toctext}](#Caracter.C3.ADsticas_pessoais)  |
|         -   [[9.1.4]{.tocnumber}                                      |
|             [Características]{.toctext}](#Caracter.C3.ADsticas)       |
|         -   [[9.1.5]{.tocnumber} [Incluir petições e                  |
|                                                                       |
|      documentos]{.toctext}](#Incluir_peti.C3.A7.C3.B5es_e_documentos) |
|         -   [[9.1.6]{.tocnumber} [Dados específicos da                |
|             classe]{.toctext}](#Dados_espec.C3.ADficos_da_classe)     |
|         -   [[9.1.7]{.tocnumber} [Processo]{.toctext}](#Processo_2)   |
|             -   [[9.1.7.1]{.tocnumber}                                |
|                 [Protocolar]{.toctext}](#Protocolar)                  |
|     -   [[9.2]{.tocnumber} [Novo processo                             |
|         incidental]{.toctext}](#Novo_processo_incidental)             |
|     -   [[9.3]{.tocnumber} [Novo processo com Jus                     |
|         Postulandi]{.toctext}](#Novo_processo_com_Jus_Postulandi)     |
|     -   [[9.4]{.tocnumber} [Complementação do cadastro - Processo não |
|         protocolado]{.toctext}](#                                     |
| Complementa.C3.A7.C3.A3o_do_cadastro_-_Processo_n.C3.A3o_protocolado) |
|     -   [[9.5]{.tocnumber} [Pesquisa]{.toctext}](#Pesquisa)           |
|         -   [[9.5.1]{.tocnumber} [Processo]{.toctext}](#Processo_3)   |
|             -   [[9.5.1.1]{.tocnumber} [Ver                           |
|                 detalhes]{.toctext}](#Ver_detalhes)                   |
|                 -   [[9.5.1.1.1]{.tocnumber}                          |
|                     [Paginador]{.toctext}](#Paginador)                |
|                 -   [[9.5.1.1.2]{.tocnumber} [Cabeçalho do            |
|                     processo]{.toctext}](#Cabe.C3.A7alho_do_processo) |
|                 -   [[9.5.1.1.3]{.tocnumber}                          |
|                     [Ferramentas]{.toctext}](#Ferramentas)            |
|                 -   [[9.5.1.1.4]{.tocnumber} [Dados do                |
|                     processo]{.toctext}](#Dados_do_processo)          |
|                 -   [[9.5.1.1.5]{.tocnumber}                          |
|                     [Processo]{.toctext}](#Processo_4)                |
|                 -   [[9.5.1.1.6]{.tocnumber} [Anexar                  |
|                     documentos]{.toctext}](#Anexar_documentos)        |
|                 -   [[9.5.1.1.7]{.tocnumber} [Aba                     |
|                     Expedientes]{.toctext}](#Aba_Expedientes)         |
|                 -   [[9.5.1.1.8]{.tocnumber} [Segredo ou              |
|                     sigilo]{.toctext}](#Segredo_ou_sigilo)            |
|                 -   [[9.5.1.1.9]{.tocnumber}                          |
|                     [Associados]{.toctext}](#Associados)              |
|                 -   [[9.5.1.1.10]{.tocnumber} [Petições               |
|                     avulsas]{.toctext}](#Peti.C3.A7.C3.B5es_avulsas)  |
|                 -   [[9.5.1.1.11]{.tocnumber}                         |
|                     [Anexos]{.toctext}](#Anexos)                      |
|                 -   [[9.5.1.1.12]{.tocnumber} [Acesso de              |
|                     terceiros]{.toctext}](#Acesso_de_terceiros)       |
|         -   [[9.5.2]{.tocnumber}                                      |
|             [Localizações]{.toctext}](#Localiza.C3.A7.C3.B5es)        |
|         -   [[9.5.3]{.tocnumber} [Informações de                      |
|             distr                                                     |
| ibuição]{.toctext}](#Informa.C3.A7.C3.B5es_de_distribui.C3.A7.C3.A3o) |
|         -   [[9.5.4]{.tocnumber} [Processo não                        |
|                                                                       |
|          distribuído]{.toctext}](#Processo_n.C3.A3o_distribu.C3.ADdo) |
|         -   [[9.5.5]{.tocnumber} [Banco Nacional de Devedores         |
|                                                                       |
|   Trabalhistas]{.toctext}](#Banco_Nacional_de_Devedores_Trabalhistas) |
|         -   [[9.5.6]{.tocnumber} [Consulta de processos de            |
|                                                                       |
|            terceiros]{.toctext}](#Consulta_de_processos_de_terceiros) |
|         -   [[9.5.7]{.tocnumber} [Consulta de processos de outras     |
|                                                                       |
| seções]{.toctext}](#Consulta_de_processos_de_outras_se.C3.A7.C3.B5es) |
|         -   [[9.5.8]{.tocnumber} [Consulta de                         |
|             prazos]{.toctext}](#Consulta_de_prazos)                   |
|             -   [[9.5.8.1]{.tocnumber} [Abrir                         |
|                 expediente]{.toctext}](#Abrir_expediente)             |
|         -   [[9.5.9]{.tocnumber} [Certidão                            |
|             Interna]{.toctext}](#Certid.C3.A3o_Interna)               |
|         -   [[9.5.10]{.tocnumber} [Certidão                           |
|             Externa]{.toctext}](#Certid.C3.A3o_Externa)               |
|     -   [[9.6]{.tocnumber} [Cadastro - Habilitação nos                |
|                                                                       |
|        autos]{.toctext}](#Cadastro_-_Habilita.C3.A7.C3.A3o_nos_autos) |
|     -   [[9.7]{.tocnumber} [Outras                                    |
|         ações]{.toctext}](#Outras_a.C3.A7.C3.B5es)                    |
|         -   [[9.7.1]{.tocnumber} [Ajustar                             |
|             movimentação]{.toctext}](#Ajustar_movimenta.C3.A7.C3.A3o) |
|         -   [[9.7.2]{.tocnumber} [Associar                            |
|             processos]{.toctext}](#Associar_processos)                |
|         -   [[9.7.3]{.tocnumber} [Chamar à                            |
|             ordem]{.toctext}](#Chamar_.C3.A0_ordem)                   |
|         -   [[9.7.4]{.tocnumber} [Enviar                              |
|             processo]{.toctext}](#Enviar_processo)                    |
|         -   [[9.7.5]{.tocnumber} [Incluir                             |
|             alerta]{.toctext}](#Incluir_alerta)                       |
|         -   [[9.7.6]{.tocnumber} [Incluir informação criminal         |
|             re                                                        |
| levante]{.toctext}](#Incluir_informa.C3.A7.C3.A3o_criminal_relevante) |
|         -   [[9.7.7]{.tocnumber} [Liberar visualização de             |
|                                                                       |
| documentos]{.toctext}](#Liberar_visualiza.C3.A7.C3.A3o_de_documentos) |
|         -   [[9.7.8]{.tocnumber} [Retificar                           |
|             autuação]{.toctext}](#Retificar_autua.C3.A7.C3.A3o_2)     |
|         -   [[9.7.9]{.tocnumber} [Solicitar                           |
|             habilitação]{.toctext}](#Solicitar_habilita.C3.A7.C3.A3o) |
|         -   [[9.7.10]{.tocnumber} [Peticionamento                     |
|             avulso]{.toctext}](#Peticionamento_avulso)                |
| -   [[10]{.tocnumber} [Atividades]{.toctext}](#Atividades)            |
|     -   [[10.1]{.tocnumber} [Assinar documentos                       |
|         pendentes]{.toctext}](#Assinar_documentos_pendentes)          |
|     -   [[10.2]{.tocnumber} [Avisos]{.toctext}](#Avisos)              |
|     -   [[10.3]{.tocnumber} [Consulta                                 |
|         pessoa]{.toctext}](#Consulta_pessoa)                          |
|     -   [[10.4]{.tocnumber} [Criar relação                            |
|         pessoal]{.toctext}](#Criar_rela.C3.A7.C3.A3o_pessoal)         |
|     -   [[10.5]{.tocnumber} [Unificar                                 |
|         pessoas]{.toctext}](#Unificar_pessoas)                        |
|     -   [[10.6]{.tocnumber} [Desunificar                              |
|         pessoas]{.toctext}](#Desunificar_pessoas)                     |
|     -   [[10.7]{.tocnumber} [Distribuição de                          |
|         expediente]{.toctext}](#Distribui.C3.A7.C3.A3o_de_expediente) |
|     -   [[10.8]{.tocnumber} [Emitir                                   |
|         certidão]{.toctext}](#Emitir_certid.C3.A3o)                   |
|     -   [[10.9]{.tocnumber} [Pauta de                                 |
|         perícia]{.toctext}](#Pauta_de_per.C3.ADcia)                   |
|     -   [[10.10]{.tocnumber} [Recebimento de expediente               |
|         físico]{.toctext}](#Recebimento_de_expediente_f.C3.ADsico)    |
|     -   [[10.11]{.tocnumber} [Redistribuição de                       |
|                                                                       |
|       expediente]{.toctext}](#Redistribui.C3.A7.C3.A3o_de_expediente) |
|     -   [[10.12]{.tocnumber} [Registrar disponibilidade de            |
|         perito]{.toctext}](#Registrar_disponibilidade_de_perito)      |
|     -   [[10.13]{.tocnumber} [Registrar indisponibilidade de          |
|         perito]{.toctext}](#Registrar_indisponibilidade_de_perito)    |
|     -   [[10.14]{.tocnumber} [Requisição de antecipação de pagamento  |
|         de                                                            |
|         perito]{.toctext}](#                                          |
| Requisi.C3.A7.C3.A3o_de_antecipa.C3.A7.C3.A3o_de_pagamento_de_perito) |
|     -   [[10.15]{.tocnumber} [Elaborar RPV ou                         |
|         precatório]{.toctext}](#Elaborar_RPV_ou_precat.C3.B3rio)      |
|     -   [[10.16]{.tocnumber} [Imprimir RPV e                          |
|         precatórios]{.toctext}](#Imprimir_RPV_e_precat.C3.B3rios)     |
|     -   [[10.17]{.tocnumber} [Simular valor a                         |
|         compensar]{.toctext}](#Simular_valor_a_compensar)             |
|     -   [[10.18]{.tocnumber} [Solicitação de antecipação de pagamento |
|         de                                                            |
|         perícia]{.toctext}](#Solicit                                  |
| a.C3.A7.C3.A3o_de_antecipa.C3.A7.C3.A3o_de_pagamento_de_per.C3.ADcia) |
| -   [[11]{.tocnumber} [Audiências]{.toctext}](#Audi.C3.AAncias)       |
|     -   [[11.1]{.tocnumber} [Pauta de                                 |
|         audiência]{.toctext}](#Pauta_de_audi.C3.AAncia)               |
|     -   [[11.2]{.tocnumber} [Integração com                           |
|         AUD]{.toctext}](#Integra.C3.A7.C3.A3o_com_AUD)                |
|         -   [[11.2.1]{.tocnumber} [Verificar audiências               |
|                                                                       |
|         importadas]{.toctext}](#Verificar_audi.C3.AAncias_importadas) |
|         -   [[11.2.2]{.tocnumber} [Assinar atar de                    |
|             audiência]{.toctext}](#Assinar_atar_de_audi.C3.AAncia)    |
| -   [[12]{.tocnumber} [Sessões]{.toctext}](#Sess.C3.B5es)             |
|     -   [[12.1]{.tocnumber} [Acórdão]{.toctext}](#Ac.C3.B3rd.C3.A3o)  |
|     -   [[12.2]{.tocnumber} [Cadastro de sessão de                    |
|                                                                       |
|        julgamento]{.toctext}](#Cadastro_de_sess.C3.A3o_de_julgamento) |
|         -   [[12.2.1]{.tocnumber} [Composição da                      |
|             sessão]{.toctext}](#Composi.C3.A7.C3.A3o_da_sess.C3.A3o)  |
|     -   [[12.3]{.tocnumber} [Pendências da sessão de                  |
|                                                                       |
| julgamento]{.toctext}](#Pend.C3.AAncias_da_sess.C3.A3o_de_julgamento) |
|     -   [[12.4]{.tocnumber} [Processos pautados em                    |
|         sessão]{.toctext}](#Processos_pautados_em_sess.C3.A3o)        |
|     -   [[12.5]{.tocnumber} [Relação de                               |
|         julgamento]{.toctext}](#Rela.C3.A7.C3.A3o_de_julgamento)      |
|         -   [[12.5.1]{.tocnumber} [Aptos para inclusão em             |
|             pauta]{.toctext}](#Aptos_para_inclus.C3.A3o_em_pauta)     |
|         -   [[12.5.2]{.tocnumber} [Aptos para inclusão em             |
|             mesa]{.toctext}](#Aptos_para_inclus.C3.A3o_em_mesa)       |
|         -   [[12.5.3]{.tocnumber} [Adiados e pautas                   |
|             anteriores]{.toctext}](#Adiados_e_pautas_anteriores)      |
|         -   [[12.5.4]{.tocnumber} [Pedido de                          |
|             vista]{.toctext}](#Pedido_de_vista)                       |
|         -   [[12.5.5]{.tocnumber} [Aptos para                         |
|             publicação]{.toctext}](#Aptos_para_publica.C3.A7.C3.A3o)  |
|         -   [[12.5.6]{.tocnumber} [Certidão de                        |
|                                                                       |
|        publicação]{.toctext}](#Certid.C3.A3o_de_publica.C3.A7.C3.A3o) |
|         -   [[12.5.7]{.tocnumber} [Votação                            |
|             antecipada]{.toctext}](#Vota.C3.A7.C3.A3o_antecipada)     |
| -   [[13]{.tocnumber} [Configuração (cadastros                        |
|     básic                                                             |
| os)]{.toctext}](#Configura.C3.A7.C3.A3o_.28cadastros_b.C3.A1sicos.29) |
| -   [[14]{.tocnumber} [Gestão]{.toctext}](#Gest.C3.A3o)               |
|     -   [[14.1]{.tocnumber} [Relatório de produtividade órgão         |
|         julgador/magistrado]{.toctext}](#R                            |
| elat.C3.B3rio_de_produtividade_.C3.B3rg.C3.A3o_julgador.2Fmagistrado) |
| -   [[15]{.tocnumber} [PJe PUSH]{.toctext}](#PJe_PUSH)                |
|     -   [[15.1]{.tocnumber} [Minhas                                   |
|         assinaturas]{.toctext}](#Minhas_assinaturas)                  |
| -   [[16]{.tocnumber} [Assinatura                                     |
|     digital]{.toctext}](#Assinatura_digital)                          |
+-----------------------------------------------------------------------+
...
1.  [Identificação](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Login "Funcionalidades")
    (login)
2.  [Consultas ao andamento
    processual](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Consulta_p.C3.BAblica "Funcionalidades")
3.  [Verificação de
    ambiente](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Verifica.C3.A7.C3.A3o_de_ambiente "Funcionalidades")
...
Os pré-requisitos para utilização explicitam as condições para que o PJe
funcione corretamente. Informações similares estão disponível no [Manual
do
...
A opção do \"Fale conosco\" exibe o conteúdo inserido no modelo de
documento da instalação referenciado pelo identificador cadastrado no
[parâmetro](http://titanio09.cnj.jus.br/wiki/index.php/Par%C3%A2metros#Modelo_de_documento "Parâmetros")
idModeloDocumentoFaleConosco.
...
[sistema](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Assinatura_digital "Funcionalidades")
...
[avisos](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Avisos "Funcionalidades")
...
[caixas](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Caixas "Funcionalidades"),
que são uma forma de o usuário organizar os processos. As caixas estão
vinculadas aos processos através das
[tarefas](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Tarefas "Funcionalidades")
...
disponível são os
[expedientes](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Expedientes "Funcionalidades"),
...
-   Ícone
    ...
    diligência](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Controle_de_visita "Funcionalidades")
-   Ícone
    [![Oculos.jpg](Funcionalidades%20-%20PJe_arquivos/Oculos.jpg){width="16"
    height="21"}](http://titanio09.cnj.jus.br/wiki/index.php/Arquivo:Oculos.jpg){.image}
...
-   Ato de comunicação: resumo do expediente contendo as seguintes
    ...
    -   Ícone
        ...
        expediente](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Preparar_comunica.C3.A7.C3.A3o "Funcionalidades")
...
-   Expediente: tipo de comunicação utilizada na [confecção do
    mandado](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Preparar_comunica.C3.A7.C3.A3o "Funcionalidades")
...
disponibilizado, o
[botão](http://titanio09.cnj.jus.br/wiki/index.php/Manual_de_refer%C3%AAncia#Bot.C3.B5es "Manual de referência")
[\"Redistribuir\"](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Redistribuir "Funcionalidades")
é habilitado.
...
-   Cadastrado em: data em que o mandado foi
    [construído](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Preparar_comunica.C3.A7.C3.A3o "Funcionalidades")
-   Destinatário
-   Endereço(s)
-   [Campo de
    seleção](http://titanio09.cnj.jus.br/wiki/index.php/Manual_de_refer%C3%AAncia#Campos_de_sele.C3.A7.C3.A3o "Manual de referência")
...
disponibilizado, o
[botão](http://titanio09.cnj.jus.br/wiki/index.php/Manual_de_refer%C3%AAncia#Bot.C3.B5es "Manual de referência")
[\"Distribuir\"](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Distribuir "Funcionalidades")
é habilitado.
...
[designação](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Designar_audi.C3.AAncia "Funcionalidades")
e de
[operações](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Opera.C3.A7.C3.B5es_da_audi.C3.AAncia "Funcionalidades").
As duas tarefas têm em comum o controle de realização das audiências por
[etapas](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Etapas "Funcionalidades").
...
autuação](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Retificar_autua.C3.A7.C3.A3o_2 "Funcionalidades").
...
[detalhes](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Ver_detalhes "Funcionalidades")
...
o momento do
[protocolo](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Protocolar "Funcionalidades").
...
habilitação](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Solicitar_habilita.C3.A7.C3.A3o "Funcionalidades").
...
[em
tarefa](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Retificar_autua.C3.A7.C3.A3o "Funcionalidades")
...
agrupador de
[mensagens](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Mensagens "Funcionalidades")
disponibilizado na [página
principal](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#P.C3.A1gina_principal "Funcionalidades").
...
[Elaborar RPV ou
precatório](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Elaborar_RPV_ou_precat.C3.B3rio "Funcionalidades")
...
[audiências](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades#Tarefas_de_audi.C3.AAncias "Funcionalidades")).
...
-   [[Página](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades "Ver a página de conteúdo [alt-shift-c]")]{#ca-nstab-main}
...
-   [[Ler](http://titanio09.cnj.jus.br/wiki/index.php/Funcionalidades)]{#ca-view}
-   [[Ver
