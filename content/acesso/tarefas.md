---
title: "Carregamento de tarefas"
date: 2026-09-10T16:30:36-03:00
weight: 9
---

O **Painel de tarefas** é utilizado pelo servidor. Por vezes pode ser que ele não carregue as tarefas e processos porque precisa de liberação no navegador do usuário (permissão de cookies de terceiros).

Se você está com problemas de não carregamento das tarefas (se a tela for apresentada em branco, é provável que o navegador esteja bloqueando o uso de cookies de terceiros), pode ser que seja  necessário fazer a configuração:
