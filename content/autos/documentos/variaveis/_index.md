...
| Magistrado responsável pelo órgão julgador (primeiro grau). Usar essa para pegar o juiz da zona. | #{orgaoJulgadorManager.recuperaResponsavel(processoTrfHome.orgaoJulgador, null)} |  |
