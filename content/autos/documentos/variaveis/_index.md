...
| Para pessoas cadastradas com a marcação do sexo como **Feminino**, escreve título Servidora ou o nome original do papel para papéis que tenham em seu texto o nome "Servidor" | #{authenticator.getPessoaLogada().sexo == 'F' and usuarioLogadoLocalizacaoAtual.papel.toString().contains('Servidor') ? 'Servidora' :usuarioLogadoLocalizacaoAtual.papel} |  |
